...
// Função que vai transcrever o audio em texto
...
// Função que vai gerar o embedding do texto que acabou de ser transcrito
...
// Função que vai devolver a melhor resposta
export async function generateAnswer(
  ...
  const prompt = `
    ...
    - Citar trechos relevantes do contexto se apropriado;
